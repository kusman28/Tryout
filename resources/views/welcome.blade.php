                    ...
                    <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                Size: {{$product->size}} | Color: {{$product->color}}</div>
                                <a href="{{ url('cart/add') }}/{{$product->id}}" class="btn btn-primary">Add to Cart</a>
                                <button type="button" data-toggle="modal" data-target="#exampleModal{{$product->id}}" class="btn btn-success">View Details</button>
                            </div>
